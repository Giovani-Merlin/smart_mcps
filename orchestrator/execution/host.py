...
class ExecutionHost(Protocol):
    ...
    def _record(self, role: object, session_id: str) -> object: ...

    def _launch_call(self) -> object: ...

    def _decisions_text(self) -> str: ...

    def _persist_reviewer_usage(self, session_id: str) -> None: ...

    def _adopt_actual_session_id(self, result: object) -> None: ...

    def _refresh_transcript(self, entry: object) -> None: ...

    def _watch_transcript(self, entry: object) -> None: ...

    def _log_coder_session_end(self) -> None: ...

    def _advance_generation(self) -> None: ...

    async def _resolve_needs_input(self, report: object) -> object: ...

    async def _on_content_filtered(self, exc: object) -> None: ...

    async def _on_coder_stuck(self, report: object, report_path: object) -> None: ...

    async def _on_reviewer_hard(self, verdict: object, verdict_path: object) -> None: ...

    async def _review_round(self, report_path: object, rounds: int) -> object: ...
